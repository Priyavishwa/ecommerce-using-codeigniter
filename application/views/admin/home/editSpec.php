    ...
    <div class="row padtop">
            ...
            <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" value="<?php echo $specs[0]['spId']; ?>" name="specId">
                    <div class="form-group">
                        <?php echo form_input('sp_name',$specs[0]['spName'],array('placeholder'=>'Enter Spec Name','class'=>'form-control')); ?>
                    </div>
                    <!--<div class="htmlitem">
